...
\begin{eqnarray}
    \label{eqn:01.11.07}
    \begin{aligned}
        \vec{r}(t)=& \vec{r}(0)+\int_{0}^{t} \vec{v}(t) d t \\
        =& \vec{r}(0)
        +\left(\int_{0}^{t} v_{x}(t) d t\right) \vec{i}
        +\left(\int_{0}^{t} v_{y}(t) d t\right) \vec{J}  \\
        &+\left(\int_{0}^{t} v_{z}(t) d t\right) \vec{k}
    \end{aligned} \\
    \label{eqn:01.11.08}
    \begin{aligned}
        \vec{v}(t)=& \vec{v}(0)+\int_{0}^{t} \vec{a}(t) d t \\
        =& \vec{v}(0)
        +\left(\int_{0}^{t} a_{x}(t) d t\right) \vec{i}
        +\left(\int_{0}^{t} a_{y}(t) d t\right) \vec{J} \\
        &+\left(\int_{0}^{t} a_{z}(t) d t\right) \vec{k}
    \end{aligned}
\end{eqnarray}
