...
\begin{eqnarray}
    \label{eqn:01.11.07}
    \begin{aligned}
        \vec{r}(t)=& \vec{r}(0)+\int_{0}^{t} \vec{v}(t) {\rm d}  t \\
        =& \vec{r}(0)
        +\left(\int_{0}^{t} v_{x}(t) {\rm d}  t\right) \vec{i}
        +\left(\int_{0}^{t} v_{y}(t) {\rm d}  t\right) \vec{j}  \\
        &+\left(\int_{0}^{t} v_{z}(t) {\rm d}  t\right) \vec{k}
    \end{aligned} \\
    \label{eqn:01.11.08}
    \begin{aligned}
        \vec{v}(t)=& \vec{v}(0)+\int_{0}^{t} \vec{a}(t) {\rm d}  t \\
        =& \vec{v}(0)
        +\left(\int_{0}^{t} a_{x}(t) {\rm d}  t\right) \vec{i}
        +\left(\int_{0}^{t} a_{y}(t) {\rm d}  t\right) \vec{j} \\
        &+\left(\int_{0}^{t} a_{z}(t) {\rm d}  t\right) \vec{k}
    \end{aligned}
\end{eqnarray}
...
\begin{equation}
    \begin{aligned}\label{eqn:01.11.09}
        x(t)=x(0)+\int_{0}^{t} v_{x}(t) {\rm d}  t \\
        y(t)=y(0)+\int_{0}^{t} v_{y}(t) {\rm d}  t \\
        z(t)=z(0)+\int_{0}^{t} v_{z}(t) {\rm d}  t
    \end{aligned}
\end{equation}}%
...
\begin{equation}\label{eqn:01.11.10}
    \begin{aligned}
        v_x(t)=v_x(0)+\int_{0}^{t} a_{x}(t) {\rm d}  t \\
        v_y(t)=v_y(0)+\int_{0}^{t} a_{y}(t) {\rm d}  t \\
        v_z(t)=v_z(0)+\int_{0}^{t} a_{z}(t) {\rm d}  t
    \end{aligned}
\end{equation}}%
