...
\begin{figure}[!h]
    ...
    \subfigure[\null]{
        \label{fig:01.06a}
        \includegraphics{figure/fig01.06a.pdf}
    }
    \hspace{3em}
    \subfigure[\null]{
        \label{fig:01.06b}
        \includegraphics{figure/fig01.06b.pdf}
    }

    \hspace{3.7em}
    \subfigure[\null]{
        \label{fig:01.06c}
        \includegraphics{figure/fig01.06c.pdf}
    }
    \hspace{1.3em}
    \subfigure[\null]{
        \label{fig:01.06d}
        \includegraphics{figure/fig01.06d.pdf}
    }
    \caption{各种运动的轨迹}
    \label{fig:01.06}
\end{figure}
...
\begin{figurex}[!h]
    \centering
    \import{figure}{fig01.07.pdf_tex}
    \caption{列车的运动}
    \label{fig:01.07}
\end{figurex}
...
\begin{wrapfigure}[14]{l}{8em}
    ...
    \begin{tikzpicture}[rotate=-90]
        \tkzInit[xmin=-4,xmax=40,xstep=10]
        \tkzDrawX[label=$X$,below,right space=1.3]
        \tkzLabelX[left=0.5em]
        \tkzLabelPoint[right](0,0.3){$t=0$}
        \tkzLabelPoint[right](0.49,0.3){$t=1$}
        \tkzLabelPoint[right](1.96,0.3){$t=2$}
        \tkzLabelPoint[right](4.41,0.3){$t=3$}
    \end{tikzpicture}
    \caption{落体的运动}
    \label{fig:01.08}
\end{wrapfigure}
...
\begin{wrapfigure}[7]{r}{11em}
    \centering
    \import{figure}{fig01.09.pdf_tex}
    \caption{曲线运动}
    \label{fig:01.09}
\end{wrapfigure}
