...
按照定义，质点相对于$K'$的速度为
\begin{equation*}
    \erratanote{\ensuremath{v(t)}}{$(t)$}[][err:02.03.01] \equiv\frac{\dif x'}{\dif t}=\frac{\dif x}{\dif t}-u
...
\begin{equation*}
    \erratanote{\ensuremath{\vec{r}'=}}{$\vec{r}=\dots$}[][err:02.03.02]\vec{r}'(t)=\vec{r}(t)-\vec{u}t-\vec{d}_0
