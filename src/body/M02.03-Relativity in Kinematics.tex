...
按照定义，质点相对于$K'$的速度为
\begin{equation*}
    \erratanote{\ensuremath{v(t)}}{$(t)$}\equiv\frac{\dif x'}{\dif t}=\frac{\dif x}{\dif t}-u
\end{equation*}
即\vspace{-1.7em}
\begin{equation}
...
\begin{equation*}
    \erratanote{\ensuremath{\vec{r}'=}}{$\vec{r}=\dots$}\vec{r}'(t)=\vec{r}(t)-\vec{u}t-\vec{d}_0
\end{equation*}
因此，质点相对于$ K' $的速度是
...
设星的真方位与观测者速度$\vec{v}$间的交角为\erratanote[疑“$\mu$”误作“$u$”。(\thesection\,节)]{$\mu$}{$u$}，星的视方位与
