...
\begin{equation*}
    A _ { 1 \to 2 } = \int _ { x _ { 1 }} ^ { x _ { 2 } } F \erratanote { \ensuremath { \dif x } } {$\dif _ x$}
\end{equation*}
以及力是保守的，即
\begin{equation*}
...
有
\begin{equation*}
    V ( x _ { 1 } ) - V ( x _ { 2 } ) = \int _ { x _ { 1 }} ^ { x _ { 2 } } F \erratanote { \ensuremath { \dif x } } {$\dif _ x$}
\end{equation*}
...
设质点的势能函数$  V ( x )   $如图\ref{fig:06.12}\;所示，这种曲线常称为势能
% 184.jpg
